        ...
        <div class="row">
            <div class="offset-2 col-8">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input readonly class="form-control" name="firstName" value="{{ $teacher->firstName }}"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="lastName" class="col-sm-2 col-form-label">Фамилия</label>
                    <div class="col-sm-10">
                        <input readonly class="form-control" name="lastName" value="{{ $teacher->lastName }}"/>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input readonly class="form-control" id="address" name="address" value="{{ $teacher->address }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="birthday" class="col-sm-2 col-form-label">Дата рождение</label>
                    <div class="col-sm-10">
                        <input readonly type="date" class="form-control" id="birthday" name="birthday" value="{{ $teacher->birthday }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nfc" class="col-sm-2 col-form-label">NFC</label>
                    <div class="col-sm-10">
                        <input readonly type="text" class="form-control" id="nfc" name="nfc" value="{{ $teacher->nfc }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="photo" class="col-sm-2 col-form-label">Foto</label>
                    <div class="col-sm-10">
                        <img src="{{ asset('uploads/teachers/' . $teacher->photo) }}" alt="" style="width: auto; height: 200px" />
                    </div>
                </div>
            </div>
        </div>
